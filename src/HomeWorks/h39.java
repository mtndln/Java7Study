...
public class h39 {
    ...
    //
    //Please Create 2 packages. Your class will be in a package and your main application will be in another package. Your age variable will be private and has a default value of 34.
